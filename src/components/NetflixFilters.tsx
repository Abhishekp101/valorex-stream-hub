...
const NetflixFilters = ({
  ...
  return (
    <div className="flex flex-col sm:flex-row sm:items-center gap-3 sm:gap-6 overflow-x-auto pb-2 scrollbar-hide">
      {/* Category Tabs */}
      ...
      <div className="flex items-center gap-1.5 sm:gap-2">
        {languages.map((lang) => (
          <motion.button
            ...
            className={`px-2.5 sm:px-4 py-1.5 sm:py-2 text-xs sm:text-sm font-medium rounded-lg border transition-all whitespace-nowrap ${
